...
public class MoneyFlatFileInterface implements AccountDatabaseInterface<Double> 
{
	...
	public MoneyFlatFileInterface(Monkey monkey) {
		this.monkey = monkey;
	}
	...
	public boolean createAccount(Player player) {
		try {
			...
			monkey.getLogger().severe("Could not create Account file " + player.getName() + "!");
		}
		return false;
	}
	...
	public Double getBalance(OfflinePlayer player) {
		...
		try {
			...
			monkey.getLogger().severe("Could not get Balance of " + player.getName() + "!");
		}
		return null;
	}
	...
	public Double getBalance(UUID playerUUID) {
		try {
			...
			monkey.getLogger().severe("Could not get Balance of " + playerUUID + "!");
		}
		return null;
	}
	...
	public boolean setBalance(OfflinePlayer player, Double amount) {
		...
		try {
			...
			monkey.getLogger().severe("Could not set Balance of "+player.getName()+"!");
		}
		return false;
	}
	...
	public boolean setBalance(UUID playerUUID, Double amount) {	
		try {
			...
			monkey.getLogger().severe("Could not set Balance of " + playerUUID + "!");
		}
		return false;
	}
}